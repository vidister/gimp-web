...
<figcaption>GIMP loads simple <strong>32bit float OpenEXR</strong> files and automatically switched to the respective precision mode (featuring a Cornell box reference file).</figcaption>
</figure>
...
Following GIMP 23.0 release, we shall start working on non-destructive editing and other much anticipated features.